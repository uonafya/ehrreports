...
public class Moh705aCohortQueries {
  ...
  public CohortDefinition getPatientsHavingOtherConvulsiveDisorders() {
    return getAdultPatientsWhoHaveDiagnosis(diagnosisMetadata.getOtherConvulsiveDisordersConceptList());
  }
  ...
  public CohortDefinition getAllDiseasesExceptThoseClassifiedMoh705A() {
    ...
    cd.addSearch(
        "46",
        EhrReportUtils.map(
            getPatientsHavingOtherConvulsiveDisorders(), "startDate=${startDate},endDate=${endDate}"));

    cd.setCompositionString(
        "ALL AND NOT (1 OR 2 OR 3 OR 4 OR 5 OR 27 OR 28 OR 29 OR 30 OR 31 OR 32 OR 33 OR 34 OR 35 OR 36 OR 37 OR 38 OR 39 OR 40 OR 41 OR 42 OR 43 OR 44 OR 45 OR 46)");
    return cd;
  }
  /**
