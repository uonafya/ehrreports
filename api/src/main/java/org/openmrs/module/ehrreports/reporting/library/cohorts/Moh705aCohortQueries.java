...
public class Moh705aCohortQueries {
  ...
  public CohortDefinition getPatientsHavingUrinaryTractInfection() {
    return getAdultPatientsWhoHaveDiagnosis(diagnosisMetadata.getUrinaryTractInfectionConceptList());
  }
  /**
...
/**
  ...
  public CohortDefinition getPatientsHavingUpperRespiratoryTractInfections() {
    return getAdultPatientsWhoHaveDiagnosis(diagnosisMetadata.getUpperRespiratoryTractInfectionsConceptList());
  }
/**
  ...
  public CohortDefinition getPatientsHavingAsthma() {
    ...
    private CohortDefinition get2nd10DiseasesToExcludeFromMainQuery() {
        ...
        cd.addSearch(
                "16",
                EhrReportUtils.map(getPatientsHavingUrinaryTractInfection(), "startDate=${startDate},endDate=${endDate}"));
        cd.addSearch(
                "17",
                EhrReportUtils.map(getPatientsHavingTyphoidFever(), "startDate=${startDate},endDate=${endDate}"));
        cd.addSearch(
                "18",
                EhrReportUtils.map(getPatientsHavingBilharzia(), "startDate=${startDate},endDate=${endDate}"));
        cd.addSearch(
                "19",
                EhrReportUtils.map(getPatientsHavingIntestinalWorms(), "startDate=${startDate},endDate=${endDate}"));
        cd.addSearch(
                "20",
                EhrReportUtils.map(getPatientsHavingMalnutrition(), "startDate=${startDate},endDate=${endDate}"));
    ...
    private CohortDefinition get3rd10DiseasesToExcludeFromMainQuery() {
        ...
        cd.addSearch(
                "21",
                EhrReportUtils.map(getPatientsHavingAnaemia(), "startDate=${startDate},endDate=${endDate}"));
        cd.addSearch(
                "22",
                EhrReportUtils.map(getPatientsHavingEyeInfections(), "startDate=${startDate},endDate=${endDate}"));
        cd.addSearch(
                "23",
                EhrReportUtils.map(getPatientsHavingOtherEyeConditions(), "startDate=${startDate},endDate=${endDate}"));
        cd.addSearch(
                "24",
                EhrReportUtils.map(getPatientsHavingUpperRespiratoryTractInfections(), "startDate=${startDate},endDate=${endDate}"));
        cd.addSearch(
                "25",
                EhrReportUtils.map(getPatientsHavingEarInfections(), "startDate=${startDate},endDate=${endDate}"));    cd.addSearch(
                "26",
