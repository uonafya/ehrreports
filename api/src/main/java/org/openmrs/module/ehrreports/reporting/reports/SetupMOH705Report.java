...
public class SetupMOH705Report extends EhrDataExportManager {
	...
	@Autowired
	private Moh705Dataset moh705Dataset;
	...
	public ReportDefinition constructReportDefinition() {
		...
		reportDefinition.addDataSetDefinition("MOH717", Mapped.mapStraightThrough(moh705Dataset.constructMoh705Dataset()));
	...
	public List<ReportDesign> constructReportDesigns(ReportDefinition reportDefinition) {
		...
		try {
			reportDesign = createXlsReportDesign(reportDefinition, "MOH_705.xls", "MOH 705 REPORT", getExcelDesignUuid(),
			    null);
